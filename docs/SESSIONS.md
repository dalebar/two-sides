...
- `docs/SESSIONS.md` — this entry; plus the "Between-sessions edits" block appended to session 2's entry in this session; plus ordering correction (sessions now newest-first as per spec).
