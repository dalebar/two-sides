...
**Status (end session 9):** Kick LOCKED (v02, session 2). Perc LOCKED (v03, session 3). Tone LOCKED (v04, session 5) — MoogFF-resonant three-saw at F2 with pitch drift, resonance drift, and function-pause cutoff automation. Convolution: algorithmic IR approach iterated across v05 through v05e. Session 9: v05d reverted v05c's tail regression in isolation (tail start back to 60ms, amplitude scale back to 1.0) — still read as "crystal box, hard smooth surfaces throughout" to Dale; spectrogram revealed amplitude failure (tail at 0.9 post-normalisation, Poisson taps at 0.05, taps swamped). v05e added sparse specular layer — 7 taps per channel at image-source-method delays for a 7m × 4.5m × 3m room, amplitudes 0.22–0.40 with per-tap HF roll-off scaling with path length. v05e TEST 1 "doesn't sound pleasant in isolation but curious about context." TEST 2 (tone alone, wet): "tone sounds good." TEST 3 (wet A/B): peak of oscillation initially felt over-wet, floor too dry. TEST 4 (primary configuration, long-listen): settled on keeping wetAmp 0.35 / wetSendAmp 1.0 — emergent borderline distortion on kick/tone interaction "phases in and out... sounds great... lends strongly to the concept we outlined at the beginning" (Dale). v05e NOT LOCKED — cold-listen pending session 10. TESTs 5/6/7 still to run. v04 remains LOCKED throughout; asymmetric-convolution question is entirely in v05-and-beyond territory. Architectural alternatives (FDN, sampled IR, Option 3) no longer active — v05e is the candidate.
